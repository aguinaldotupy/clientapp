...
<!-- Fim da verificação -->
        <form class="form" method="post" action="{{route('client.store')}}">
            ...
            <div class="form-group">
                Nome: <input type="text" class="form-control" name="name" placeholder="Nome do cliente" value="{{old('name')}}">
            </div>

            <div class="form-group">
                E-mail: <input type="email" class="form-control" name="email" placeholder="email.cliente@gmail.com" value="{{old('email')}}">
            </div>
            ...
            <hr>
            <div class="form-group">
                Solicitação: <textarea class="form-control" name="description" placeholder="O produto que o cliente deseja comprar. Exemplo: Semente de chia">{{old('description')}}</textarea>
            </div>
